...
final class SwapOfferAggregateSignerJsonForm extends FormBase {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state): void {
    if (!$this->offers->canSubmitSignedPayload($this->offer)) {
      $form_state->setErrorByName('signature_json', $this->t('Root signed payload can only be built for payload-generated or already signed settlements with a valid intent hash.'));
    }
