...
final class SymbolEngineClient {
  ...
  private function baseUrl(): string {
    $base_url = getenv('SYMBOL_ENGINE_BASE_URL') ?: (string) ($this->configFactory->get('symbol_engine.settings')->get('engine_base_url') ?: 'http://symbol-engine:3000');
  ...
  private function timeout(): float {
    $timeout = getenv('SYMBOL_ENGINE_TIMEOUT') ?: (string) ($this->configFactory->get('symbol_engine.settings')->get('engine_timeout') ?: '10');
